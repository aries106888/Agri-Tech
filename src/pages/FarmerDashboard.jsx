      ...
      <div className="bg-ag-primary-cont border border-ag-primary rounded-card p-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-4xl font-extrabold text-white">KSh {walletBalance.toLocaleString()}</p>
            <p className="text-white/50 text-xs mt-1 font-bold">Last updated: Just now</p>
          </div>
          <div className="flex flex-wrap gap-3">
            ...
            <button onClick={() => setModal('transactions')} className="btn-secondary !min-h-0 !py-3 !text-sm !border-white !text-white hover:!bg-white/10">
