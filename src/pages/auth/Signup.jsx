...
import { User, Mail, Phone, Lock, MapPin, Tractor, Briefcase, Truck, Shield, AlertCircle, CheckCircle, Eye, EyeOff } from 'lucide-react';
...
const Signup = () => {
  ...
  const step = 0; // single-page signup form
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-ag-outline hover:text-ag-body focus:outline-none"
                title={showConfirmPassword ? 'Hide password' : 'Peek password'}
              >
