...
/* ── Chunk Error Boundary (stale deploy fix) ───────────── */
class ChunkErrorBoundary extends Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-ag-canvas gap-4 p-8">
          <div className="text-4xl">🔄</div>
          <p className="font-bold text-ag-body text-lg">Update available — reloading…</p>
          <p className="text-ag-muted text-sm text-center max-w-sm">
      ...
      <ChunkErrorBoundary>
        ...
        <Routes>
          ...
          <Route element={<TopNavLayout />}>
            ...
            <Route path="storage"       element={<SmartStorage />} />
            <Route path="payment"       element={<SmartSecurePay />} />
            <Route path="securepay"     element={<SmartSecurePay />} />
            <Route path="transport"     element={<TransportPage />} />
          </Route>
